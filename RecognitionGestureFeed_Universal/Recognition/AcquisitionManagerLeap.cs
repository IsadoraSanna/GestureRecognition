...
namespace RecognitionGestureFeed_Universal.Recognition
{
    ...
    public class AcquisitionManagerLeap : Listener
    {
        ...
        private void OnInit(Controller controller)
        {
        ...
        private override void OnConnect(Controller controller)
        {
        ...
        /// </summary>
        /// <param name="controller"></param>
        private override void OnDisconnect(Controller controller)
        {
        ...
        /// </summary>
        /// <param name="controller"></param>
        private override void OnExit(Controller controller)
        {
        }

        private override void OnFrame(Controller controller)
        {
            //
        ...
        private void OnServiceDisconnect(Controller controller)
        {

        }

        private void OnServiceConnect(Controller controller)
        {

        }

        private void OnImages(Controller controller)
        {

        }

        private void OnFocusGained(Controller controller)
        {

        }

        private void OnFocusLost(Controller controller)
        {

        }

        private void OnDeviceChange(Controller controller)
        {
